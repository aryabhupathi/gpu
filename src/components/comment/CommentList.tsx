    ...
    <>
      ...
      <Container maxWidth="lg">
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              Posted by {currentForum.user.name} · {formatDistanceToNow(new Date(currentForum.createdAt), { addSuffix: true })}
            </Typography>
          </Box>
        ...
        {session ? (
          ...
          <Typography sx={{ my: 2 }}>
            Please <Button component="a" href="/auth/signin">sign in</Button> to add a comment.
          </Typography>
        )}
